...
class PublicUserApiTest(TestCase):
    ...
    def test_password_too_short(self):
        """Password must be more that 5 characters"""
    ...
    def test_create_token_invalid_credentials(self):
        """Test that the token is invalid credentials are given"""
    ...
    def test_create_token_no_user(self):
        ...
        payload = {'email': 'test@email.com', 'password': 'ptestpass'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_retrieve_user_unuthorized(self):
...
class PrivateUserApiTests(TestCase):
    ...
    def test_retrieve_rofile_success(self):
    ...
    def test_upadtre_user_profile(self):
